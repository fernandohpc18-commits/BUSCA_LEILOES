...
// Importando com os novos nomes para forçar a Vercel a encontrar os arquivos
import Lotes from "./pages/view-lotes.jsx";
import Rastreamento from "./pages/view-investigar.jsx";
        ...
        <nav className="border-b border-slate-800 bg-slate-900/80 backdrop-blur-md sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
            ...
            <div className="flex gap-8">
              <Link to="/" className="text-sm font-semibold hover:text-amber-400 transition-colors">
                <LayoutDashboard className="w-4 h-4 inline mr-1" /> Painel
              </Link>
              <Link to="/rastreamento" className="text-sm font-semibold hover:text-amber-400 transition-colors">
